...
<body>
    ...
    <div class="ff">
  <label ><?php $a=$_SESSION['role'];$b=$_SESSION['user'];echo"$a: $b" ;?></label><br>
  <?php if($_SESSION['role']== "ADMIN"){ echo"<button ><a  href='dash/addP.php'>Add Porduct</a></button><br>";}?>
      ...
      <div class="main-content" style="display:flex ; flex-wrap:wrap;">
         ...
         ?>
                     <div class='card' style="width:20%">
                         <a href=<?php echo "/vitalogicgroupe/View/specificP.php?id=".$produit["id"] ?>>
