...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="images/icon_tab.png" />
  </head>
  <body>
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><img src="assets/images/vitalogic-6logo.png" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="assets/images/vitalogic-6logo.png" alt="logo" /></a>
        </div>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                ...
                <li class="nav-item"> <a class="nav-link" href="dash/addE.php">Add Event</a></li>
                                ...
                                <li class="nav-item"> <a class="nav-link" href="dash/showparticip.php">Show Participants</a></li>
                                <li class="nav-item"> <a class="nav-link" href="dash/delE.php">Delete Events</a></li>
                                <li class="nav-item"> <a class="nav-link" href="dash/modiE.php">Modify Events</a></li>
                </ul>
              </div>
            </li>
            <ul class="nav">
