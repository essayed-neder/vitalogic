          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="showparticip.php">Show Participants</a></li>
                                <li class="nav-item"> <a class="nav-link" href="delE.php">Delete Events</a></li>
                                <li class="nav-item"> <a class="nav-link" href="modiE.php">Modify Events</a></li>
              </ul>
            </div>
          </li>
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic4">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="stat.php">Stats</a></li>
                </ul>
              </div>
            </li>
