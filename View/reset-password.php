            ...
            <section class="block">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-4">
                            <form class="form clearfix" action="password-reset-code.php" method="POST">
                    ...
                    <div class="d-flex justify-content-between align-items-baseline">           
                                    <input type="submit" name='forgot-password' class="btn btn-primary" value="Send email"></input>
                                </div>
                                </div>
                                </form>    
                </div>
